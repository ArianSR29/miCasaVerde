...
$mysqli = new mysqli('localhost', 'root', '', 'micasaverde');
 ...
 $correo       = @trim(stripslashes($_POST['tb-correo']));
...
$mail->addAddress('jaimeisraels.m@gmail.com');     // Add a recipient
    ...
    $mail->Body    .= utf8_decode("Información: <br>");
    ...
    $sql="INSERT INTO `vales` (`id`, `nombre`, `correo`,`telefono`,`fecha`) VALUES (NULL, '$nombre', '$correo', '$telefono',NULL)";
